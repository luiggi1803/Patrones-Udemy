...
class MagicString {
    ...
    ///////////////////
    public long getNumbersOfVowels() {
...
public class MagicStringDemo {
    public static void main(String[] args) {
        MagicString magicString = new MagicString("luiggi");
        System.out.println(magicString.string + " has " + magicString.getNumbersOfVowels() + " vowels");
